...
<div class="content">
    ...
    <form  action="researchinfoapi.php" method="POST">
        <div class="relative"> 
            ...
            <?php echo  '<textarea class="form-control border border-primary"   id="exampleFormControlTextarea1" name="Abstract" rows="3" disabled="disabled"> '.$ResearchInfo['Abstract'].' </textarea>'?>
            </div>
            <h2>Research Info</h2>
